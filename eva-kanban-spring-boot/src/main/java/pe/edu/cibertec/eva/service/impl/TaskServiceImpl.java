...
public class TaskServiceImpl implements TaskService {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<TaskEntity> findAllFor(UserEntity user) {
    ...
    @Override
    @Transactional(readOnly = true)
    public Map<String, Long> metricsFor(UserEntity user) {
    ...
    @Override
    @Transactional
    public TaskEntity create(TaskEntity t, UserEntity actor, Long ownerId, Long assigneeId) {
    ...
    @Override
    @Transactional
    public TaskEntity update(TaskEntity t, UserEntity actor, Long ownerId, Long assigneeId) {
        TaskEntity db = findById(t.getId());
        ...
        TaskEntity saved = tasks.save(db);
    ...
    @Override
    @Transactional
    public TaskEntity updateStatus(Long id, Status newStatus, UserEntity actor) {
        TaskEntity db = findById(id);
    ...
    @Override
    @Transactional
    public TaskEntity updateStatus(Long id, Status newStatus) {
    ...
    @Override
    @Transactional
    public TaskEntity reassign(Long id, String newUsername, UserEntity actor) {
        TaskEntity db = findById(id);
        if (!isAdmin(actor)) throw new IllegalStateException("Solo ADMIN puede reasignar");
        UserEntity assignee = users.findByUsername(newUsername).orElseThrow();
    ...
    @Override
    @Transactional
    public TaskEntity reassign(Long id, String newUsername) {
