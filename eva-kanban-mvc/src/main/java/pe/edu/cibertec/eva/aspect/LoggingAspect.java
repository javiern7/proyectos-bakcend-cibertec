...
public class LoggingAspect {
  ...
  public void logCreate(Task task, User user, Object result){
    ...
    log.info("TASK-CREATE by={} id={} title='{}' assignee={}", user.getUsername(), saved.getId(), saved.getName(), saved.getUsername());
  }

  @AfterReturning(pointcut = "execution(* pe.edu.cibertec.eva.service.TaskService.updateStatus(..)) && args(id, status, user)",
                  returning = "result")
  public void logUpdate(Long id, String status, User user, Object result){
